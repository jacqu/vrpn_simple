...
// L.C x2 class VRPN_API vrpn_LamportClock;  // from "vrpn_LamportClock.h"
...
class VRPN_API vrpn_SharedObject {
  ...
  public:
    ...
    //L.C void useLamportClock (vrpn_LamportClock *);
  ...
  protected:
    ...
    // L.C x2 vrpn_LamportClock * d_lClock;
